        ...
        <>
            <motion.section
                ...
                <div className={"container relative mt-16"}>
                    ...
                    <p className={"text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-center"}>Your earthly companion, earthing with you all the time for your Quality Computer e𝕏perience</p>
