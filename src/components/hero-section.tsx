    ...
    return (
        <>
            ...
            >
                ...
                {/* Hero Section Content - Initial State */}
                ...
                {/* Planet Animation - Moves to the right after click */}
                <motion.div
                    ...
                    animate={isAnimating ? { x: '25vw' } : {}}
                    transition={{ duration: 2 }}
                />

                {/* Rings + Mini planets Animation - Adjusts position with the sphere */}
                <motion.div
                ...
                {/* Chat Input - Appears on the left after click */}
                {showChatInput && (
