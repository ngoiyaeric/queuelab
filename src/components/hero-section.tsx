        ...
        <>
            <motion.section
                ...
                <div className={"container relative mt-16"}>
                    ...
                    <p className={"font-handwriting text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-center italic flex justify-center"}>is a multi-agent intelligence platform for exploration and automation. Your earth copilot, earthing for your</p> 
