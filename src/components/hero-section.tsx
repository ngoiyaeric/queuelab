        ...
        <>
            <motion.section
                ...
                <div className={"container relative mt-16"}>
                    <h1 className={"text-8xl md:text-[168px] md:leading-none font-semibold bg-white tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(0,0,255,0.5))] bg-clip-text text-transparent text-center md:text-left"}>QCX</h1>
                    <p className={"text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-center md:text-left"}>Quality Computer Experience</p>
