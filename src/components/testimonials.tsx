        ...
        <>
            <section id={id} className={"py-20 md:py-24"}>
                <div className={"container"}>
                    ...
                    <p className={"text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto text-center tracking-tight mt-5"} style={{ fontFamily: "var(--font-instrument-serif)" }}>Our entire suite of products together function as Artificial General Intelligence, starting with QCX.</p>
