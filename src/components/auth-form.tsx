...
export function AuthForm() {
    ...
    return (
        <div className="p-6 md:p-8 bg-sky-600/40 rounded-lg shadow-xl border border-white/10 text-white w-full max-w-md mx-auto">
            ...
            <form onSubmit={handleAuthAction} className="space-y-5">
                <div>
                    ...
                    <input
                        ...
                        required
                        className="mt-1 block w-full px-3 py-2.5 bg-sky-700/50 border-sky-500/70 rounded-md shadow-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 sm:text-sm"
                ...
                <div className="text-center text-sm text-gray-300 mt-6">
                    {isLoginView ? 'Queue in a new account' : 'Queue up an existing'}
                </div>
            </form>
        </div>
    );
